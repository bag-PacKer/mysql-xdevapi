...
function Client (options = {}) {
    ...
    return {
        ...
        /**
         * Returns the current size of active connections in the pool.
         * @private
         * @function
         * @name module:Client#activeConnections
         * @returns {number} The size of connection instances.
         */
         activeConnections () {
            if (options.pooling.enabled) {
                return state.pool.activeConnections().length;
            }
            return -1
        },

        /**
         * Returns the current size of idle connections in the pool.
         * @private
         * @function
         * @name module:Client#idleConnections
         * @returns {number} The size of connection instances.
         */
         idleConnections () {
            if (options.pooling.enabled) {
                return state.pool.idleConnections().length;
            }
            return -1
        },

        /**
         * Returns the current size of expired connections in the pool.
         * @private
         * @function
         * @name module:Client#expiredConnections
         * @returns {number} The size of connection instances.
         */
         expiredConnections () {
            if (options.pooling.enabled) {
                return state.pool.expiredConnections().length;
            }
            return -1
        }
    };
